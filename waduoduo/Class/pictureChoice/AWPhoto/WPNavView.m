...
-(void)createNavViewTitle:(NSString *)title {
    ...
    UILabel *titleLab = [[UILabel alloc]initWithFrame:CGRectMake(0, JLNavY(20), 80, navView_H-JLNavY(20))];
    titleLab.text = title;
    ...
    titleLab.center = CGPointMake(nav.center.x, (navView_H-JLNavY(20))/2+JLNavY(20));
