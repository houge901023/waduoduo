...
#define navView_H (iPhoneX ? 88 : 64)
...
// 相册列表页面上端文字的颜色
#define WPhoto_TopText_Color UIColorFromRGB(0x333333)

/*
 图片
 */
//   相册列表页面左边返回箭头图片
#define WPhoto_Btn_Back      [UIImage imageNamed:@"icon_back"]
//   图片选中状态图片
#define WPhoto_Btn_Selected       [UIImage imageNamed:@"wphoto_select_yes"]
//   图片未选中状态图片
#define WPhoto_btn_UnSelected     [UIImage imageNamed:@"wphoto_select_no"]
