...
//    }];
    ...
    self.completeBtn.frame = CGRectMake(SCREEN_WIDTH-55, 0, 40, 44);
...
//    WS(ws);
    ...
    self.titleLab.frame = CGRectMake(60, 0, SCREEN_WIDTH-120, 44);
...
//    }];
    ...
    self.line.frame = CGRectMake(0, 43.5, SCREEN_WIDTH, 0.5);
    ...
    switch (type) {
        ...
        case PickerViewTypeBirthday:
        {
           ...
           [self isDataPicker:YES];
            ...
            self.datePicke.locale = [[NSLocale alloc]initWithLocaleIdentifier:@"zh_CN"];
            [self.datePicke setMinimumDate:[PickerView distanceYear:-100]];
            [self.datePicke setMaximumDate:[PickerView distanceYear:10]];
...
//    WS(ws);
    ...
    if (isData) {
        ...
        self.datePicke.frame = CGRectMake(0, 44, SCREEN_WIDTH, _bgView.height-40);
...
//        }];
        ...
        self.picker.frame = CGRectMake(0, 44, SCREEN_WIDTH, _bgView.height-40);
